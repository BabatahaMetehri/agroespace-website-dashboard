    ...
    <div className="bg-[#f4f7f5] pt-32 pb-24" style={{ position: "relative" }}>
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="max-w-3xl mb-16">
          ...
          <h1 className="text-5xl md:text-7xl font-light text-[#0f2618] leading-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {items.map(({ icon: Icon, to, key, img }, i) => (
            ...
            >
              <Link
                to={to}
                className="group block bg-white rounded-3xl overflow-hidden border border-[#114232]/5 shadow-[0_15px_40px_rgba(0,0,0,0.04)] hover:shadow-[0_25px_60px_rgba(0,0,0,0.08)] hover:-translate-y-1 transition-all duration-500"
              >
                <div className="relative aspect-[5/4] overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0f2618]/40 to-transparent" />
                </div>
                <div className="p-8">
                  <div className="w-12 h-12 rounded-full bg-[#f4f7f5] flex items-center justify-center mb-5">
                    <Icon
                      className="w-5 h-5 text-[#114232]"
                      strokeWidth={1.5}
                    />
                  </div>
                  <h2 className="text-2xl font-medium text-[#0f2618] mb-3 leading-tight">
                    {t(`services.${key}.title`)}
                  </h2>
                  <p className="text-gray-500 leading-relaxed text-sm md:text-[15px] mb-6">
                    {t(`services.${key}.desc`)}
                  </p>
                  <div className="inline-flex items-center gap-2 text-[#0f2618] font-semibold text-sm group-hover:text-[#87A922] transition-colors">
                    {t("services.cta")}
